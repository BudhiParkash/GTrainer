package com.skywalkers.gtrainer;
...
import com.skywalkers.gtrainer.Adapter.AddvertismentAdapter;
import com.skywalkers.gtrainer.Adapter.AllTrainerList_Adpter;
import com.skywalkers.gtrainer.Adapter.PopularPlan_Adapter;
...
import com.skywalkers.gtrainer.ui.Activity.All_List_Trainer;
import com.skywalkers.gtrainer.ui.Activity.SearchActivity;
import com.skywalkers.gtrainer.ui.Activity.TrainerDetailActivity;
import com.skywalkers.gtrainer.ui.SideMenuActivity.Apply_For_Trainer;
import com.skywalkers.gtrainer.ui.SideMenuActivity.BookingActivity;
import com.skywalkers.gtrainer.ui.SideMenuActivity.HelpActivity;
import com.skywalkers.gtrainer.ui.SideMenuActivity.PrivacyAndPolicyActivity;
import com.skywalkers.gtrainer.ui.SideMenuActivity.TermsAndConditionActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    private List<PopuplarPlanModel> planModelList = new ArrayList<>();
    ...
    private RecyclerView mPopularplans;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        planModelList.add(new PopuplarPlanModel(R.drawable.plan2));
        planModelList.add(new PopuplarPlanModel(R.drawable.plan));
        planModelList.add(new PopuplarPlanModel(R.drawable.plan3));
        planModelList.add(new PopuplarPlanModel(R.drawable.plan4));
        planModelList.add(new PopuplarPlanModel(R.drawable.plan5));

        mPopularplans.setHasFixedSize(true);
        mPopularplans.setLayoutManager(new LinearLayoutManager(this, LinearLayoutManager.HORIZONTAL, false));
        PopularPlan_Adapter popularPlan_adapter = new PopularPlan_Adapter(MainActivity.this, planModelList);
        mPopularplans.setAdapter(popularPlan_adapter);
  ...
  /*      mViewAllTrainer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this, TrainerDetailActivity.class);
                startActivity(intent);
            }
        });*/
    ...
    private void initView() {
       ...
       // mViewAllTrainer = findViewById(R.id.btnViewAllTrainer);
        ...
        mPopularplans = (RecyclerView) findViewById(R.id.popularplans);
    }
}